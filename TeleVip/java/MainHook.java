...
public class MainHook extends StrVip implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(final XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        if (lpparam.packageName.equals("org.telegram.messenger") || lpparam.packageName.equals("org.telegram.messenger.web") || lpparam.packageName.equals("org.telegram.messenger.beta")){
...
if (te.contains(String.valueOf((long)(userlong)))) {
       ...
       }else if (lpparam.packageName.equals("com.iMe.android")){    
       teleim.Start(lpparam);                     
       }else if (lpparam.packageName.equals("com.xplus.messenger")){    
       telexplus.Start(lpparam);                     
       }else if (lpparam.packageName.equals("xyz.nextalone.nagram")){    
       teleng.Start(lpparam);                     
       }else if (lpparam.packageName.equals("uz.unnarsx.cherrygram")){    
       telech.Start(lpparam);                     
       }else if (lpparam.packageName.equals("app.nicegram")){    
       teleni.Start(lpparam);                     
       }else if (lpparam.packageName.equals("com.exteragram.messenger")){    
       telexe.Start(lpparam);                     
       }else if (lpparam.packageName.equals("tw.nekomimi.nekogram")){    
       telenk.Start(lpparam);                     
       }else if (lpparam.packageName.equals("org.forkclient.messenger.beta")){    
       telefo.Start(lpparam);                     
       }else if (lpparam.packageName.equals("org.forkgram.messenger")){    
       telefo.Start(lpparam);                     
       }else{       
        return;
        }
