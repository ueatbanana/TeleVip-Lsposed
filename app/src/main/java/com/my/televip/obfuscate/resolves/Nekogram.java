...
public class Nekogram {
    ...
    static {
        ...
        methodList.add(new MethodInfo("MessagesStorage", "markMessagesAsDeletedInternal", "hb"));
        ...
        methodList.add(new MethodInfo("MessagesController", "markDialogMessageAsDeleted", "pl"));
